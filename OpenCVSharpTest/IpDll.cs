...
namespace OpenCVSharpTest {
    class IpDll {
        ...
        [DllImport("IP.dll")] extern public static void ErodeCStl(IntPtr srcPtr, IntPtr dstPtr, int bw, int bh, int step);
        ...
        [DllImport("IP.dll")] extern public static void ErodeSseOpenMP(IntPtr srcPtr, IntPtr dstPtr, int bw, int bh, int step);
        [DllImport("IP.dll")] extern public static void ErodeIpp(IntPtr srcPtr, IntPtr dstPtr, IntPtr workPtr, int bw, int bh, int step);
    }
}
