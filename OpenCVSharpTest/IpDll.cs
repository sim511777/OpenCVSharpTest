...
namespace OpenCVSharpTest {
    class IpDll {
        ...
        [DllImport(dll)] public static extern unsafe void Devernay(ref IntPtr x, ref IntPtr y, ref int N, ref IntPtr curve_limits, ref int M, IntPtr image, int X, int Y, double sigma, double th_h, double th_l);
