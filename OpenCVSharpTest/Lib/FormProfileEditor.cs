...
namespace ShimLib {
   public partial class FormProfileEditor : Form {
      ...
      int lastXIdx = 0;
      double lastYVal = 0;
      private void ProfileEqualize(MouseEventArgs e, bool mouseMove) {
         double xVal;
         double yVal;
         try {
         ...
         if (bShift) yVal = ((int)Math.Round(yVal)+2) / 5 * 5;
         yVal = yVal.Range(0, 100);
      ...
      private void chtProfile_MouseDown(object sender, MouseEventArgs e) {
         ...
         bClick = true;
         this.ProfileEqualize(e, false);
      }

      private void chtProfile_MouseUp(object sender, MouseEventArgs e) {
         bClick = false;
      }
    ...
    class FormPropertyProfileEditor : UITypeEditor {
      ...
      public override object EditValue(ITypeDescriptorContext context, System.IServiceProvider provider, object value) {
         ...
         FormProfileEditor form = new FormProfileEditor();
         double[] values = value as double[];
         form.Profiles = values;
